...
public class ASCollectionViewParallaxCell: UICollectionViewCell {
    ...
    private func setUp() {
        ...
        parallaxImageViewWidthConstraint = NSLayoutConstraint(item: parallaxImageView, attribute: .width, relatedBy: NSLayoutRelation.equal, toItem: contentView, attribute: .width, multiplier: 1, constant: 0)
        parallaxImageViewHeightConstraint = NSLayoutConstraint(item: parallaxImageView, attribute: .height, relatedBy: NSLayoutRelation.equal, toItem: contentView, attribute: .height, multiplier: 1, constant: 0)
        parallaxImageViewCenterXConstraint = NSLayoutConstraint(item: parallaxImageView, attribute: .centerX, relatedBy: NSLayoutRelation.equal, toItem: contentView, attribute: .centerX, multiplier: 1, constant: 0)
        parallaxImageViewCenterYConstraint = NSLayoutConstraint(item: parallaxImageView, attribute: .centerY, relatedBy: NSLayoutRelation.equal, toItem: contentView, attribute: .centerY, multiplier: 1, constant: 0)
        
        contentView.addConstraint(parallaxImageViewWidthConstraint)
        contentView.addConstraint(parallaxImageViewHeightConstraint)
        contentView.addConstraint(parallaxImageViewCenterXConstraint)
        contentView.addConstraint(parallaxImageViewCenterYConstraint)
    }
